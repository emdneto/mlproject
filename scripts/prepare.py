...
class Prepare:
    ...
    def __init__(self):
        ...
        self.modifiedPath = path.join(self.path, 'modified')
        self.peak = None
    ...
    def readCSV(self):
        ...
        for csvFile in csvFiles:
            ...
            col_names = ['Timestamp', 'CellID', 'DL_bitrate', 'UL_bitrate', 'State']
            dataset = pd.read_csv(filepath, usecols=col_names)
            ...
            print(dataset.groupby('CellID').size())
            break
p = Prepare()
